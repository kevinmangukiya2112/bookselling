      ...
      <div className="container">
        ...
        <Grid container className="title-wrapper">
          ...
          <div className="dropdown-wrapper">
            <TextField
              id="text"
              style={{color: "#65350f",border: "1px solid black"}}
              ...
              <div className="product-list" key={index}>
                <div className="product-list-inner">
                  ...
                  <div className="content-wrapper">
                    <h3 style={{color: "#65350f"}}>{book.name}</h3>
                    <span className="category" style={{color: "green"}}>{book.category}</span>
                    <p className="description">{book.description}</p>
                    <p className="price">
                      <span className="discount-price" style={{color: "#65350f"}}>
                        MRP &#8377; {book.price}
                      </span>
                    </p>
